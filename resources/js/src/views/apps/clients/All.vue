  ...
  <div id="page-clients-list">
    ...
    <div class="vx-card p-6">
        ...
        <div class="vx-card__header table-header">
            ...
            <span class="vx-card__actions cursor-pointer" @click="createNewClient">
  ...
  methods: {
    ...
    confirmDeleteRecords() {
        ...
        this.$vs.dialog({
            ...
            text: `You are about to delete selected clients`,
    ...
    deleteRecord() {
        this.$vs.loading()
        this.$store.dispatch("userManagement/removeRecords", this.ids)
        .then(()   => {
    ...
    showDeleteSuccess() {
        this.$vs.notify({
            ...
            position:'top-right',
            text: 'The selected clients were successfully deleted'
        })
    },
    createNewClient() {
        this.$router.push("/clients/client_add").catch(() => {})
    }
  },
  mounted() {
