        ...
        submitForm() {
            this.$validator.validateAll().then(result => {
                if(result) {
                    ...
                    this.$store.dispatch("propertyManagement/addProperty", post_data)
                    .then(res => {
    ...
    created() {
        ...
        .then(response => {
            if (this.$route.params.clientId) {
                const userIndex = this.$store.state.userManagement.users.findIndex((u) => u.id == this.$route.params.clientId)
                this.client = this.$store.state.userManagement.users[userIndex]
            }
        })
