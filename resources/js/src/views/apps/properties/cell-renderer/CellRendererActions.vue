...
<script>
    export default {
        ...
        methods: {
            viewRecord() {
                this.$router.push("/properties/property_view/" + this.params.data.id).catch(() => {})
            },
            editRecord() {
                this.$router.push("/properties/property_edit/" + this.params.data.id).catch(() => {})
            },
            confirmDeleteRecord() {
                this.$vs.dialog({
                    type: 'confirm',
            ...
            deleteRecord() {
                ...
                this.$store.dispatch("propertyManagement/removeRecord", this.params.data.id)
